		...
		<!--gooey-->
            ...
            <div class="">
                      ...
                      <h5>
                            ...
                            if(!empty($_GET['message'])) {
                                if($_GET['message']=="success") {
                                    ...
                                    <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\" title=\"close\">×</a>
                                    Designation Adding Unfortunately Failed, Please Try Again Later
                                    </div>";
                                } else if($_GET['message']=="deletesuccess") {
                                    echo "<div class=\"alert alert-success fade in alert-dismissable\">
                                    <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\" title=\"close\">×</a>
                                    Designation Successfully Deleted.
                                    </div>";
                                } else if($_GET['message']=="deletefailed") {
                                    echo "<div class=\"alert alert-danger fade in alert-dismissable\">
                                    <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\" title=\"close\">×</a>
                                    Designation deletion Unfortunately Failed, Please Try Again Later
                                    </div>";
                                }
                            }
                            ?>
                ...
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                            <form action="../../src/store/dept/desigStore.php" enctype="multipart/form-data" method="post" novalidate="novalidate">
                                <div class="form-body">
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Designation Name</label>
                                                <input name="designation" class="form-control" id="firstName" required="" type="text" placeholder="" minlength="3" value="">
                                            </div>
                                        </div>
                                        <!--/span-->
                                    </div>
                ...
                <div class="card-body">
                    <div class="table-responsive ">
                        <table width="100%" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Designation </th>
                                    <th>Edit</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center">
                                        <a title="Edit" class="btn btn-sm btn-info waves-effect waves-light" href="../../src/store/dept/desigEdit.php"><i class="fa fa-pencil-square-o"></i></a>
								                  	</td>
                  									<td class="jsgrid-align-center">

                  										<form action="../../src/store/dept/desigDelete.php" method="post">
                  											<input type="hidden" name="delete_id" value="<?=$designation['id']?>">
